...
// @updateURL    https://github.com/arsinclair/browser-userscripts/raw/dist/bandcamp-discography-pruner.user.js
...
(function () {
    ...
    const ACTION_BUTTON_CLASS = "discography-pruner-action";
    const CONTROLS_CLASS = "discography-pruner-controls";
    const TOGGLE_CLASS = "discography-pruner-toggle";
    const PRUNED_CLASS = "discography-pruner-hidden";
    const SHOW_HIDDEN_CLASS = "discography-pruner-show-hidden";
    const STYLE_ID = "discography-pruner-styles";
    const CSS = `
    ${ITEM_SELECTOR} {
        position: relative;
    }
