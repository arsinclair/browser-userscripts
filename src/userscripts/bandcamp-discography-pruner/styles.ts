...
export const ACTION_BUTTON_CLASS = "discography-pruner-action";
export const CONTROLS_CLASS = "discography-pruner-controls";
export const TOGGLE_CLASS = "discography-pruner-toggle";
export const PRUNED_CLASS = "discography-pruner-hidden";
export const SHOW_HIDDEN_CLASS = "discography-pruner-show-hidden";
